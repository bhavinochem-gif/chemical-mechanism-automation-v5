"""RDKit structure utilities. RDKit drawing is deliberately NOT imported here."""
...
def enrich_step(step):
    ...
    step["atom_mapping_note"] = (
        "V5.1 does not claim exact atom mapping. Reaction-center and electron-flow statements are proposals "
